...
describe('FRONTEND Usuarios', () => {
    ...
    it('Verificando tela de cadastro', () => {
        cy.verificarCadastroDeUsuario()
    })

    it('Verificando tela de lista de usuários cadastrados', () => {
...
describe('FRONTEND Produtos', () => {
    ...
    it('Verificando tela de cadastro de produto', () => {
        cy.verificarCadastroDeProduto()
    })

    it('Verificando tela de lista de produtos cadastrados', () => {
